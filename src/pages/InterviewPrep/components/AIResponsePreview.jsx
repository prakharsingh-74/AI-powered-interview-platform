        ...
        <div className='text-[14px] prose prose-slate dark:prose-invert max-w-none'>
            <ReactMarkdown
                ...
                components={{
                    ...
                    th({children}){
                        return <th className='px-3 py-2 text-left text-xs font-medium text-gray-500 uppercase tracking-widder'>{children}</th>;
                    },
                    td({children}){
                        return <td className='px-3 py-2 whitesapce-nowrap text-sm'>{children}</td>;
                    },
                    hr(){
