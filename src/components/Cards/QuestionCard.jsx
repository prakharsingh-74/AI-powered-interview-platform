...
const QuestionCard = ({
    ...
    return (
        <div className='w-full md:w-[700px] bg-white rounded-lg mb-4 overflow-hidden py-4 px-5 shadow-xl shadow-gray-100/70 border border-gray-100/60 group'>
            <div className='flex items-start justify-between cursor-pointer'>
                ...
                <div className='flex items-center jutify-end ml-4 relative'>
                    <div
                     className={`flex ${
                    ...
                    >
                       ...
                       <button
                         ...
                         onClick={()=>{
                            setIsExpanded(true);
                            onLearnMore && onLearnMore(); // Add safety check
                         }}
                       >
                        <LuSparkles/>
